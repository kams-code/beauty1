<div class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title">Modifier un abonnement</h4>
    </div>
    <div class="modal-body">
        <div class="row">
            {!! Form::open(['method' => 'PUT','class' => 'form-horizontal','role' => 'form','url' => route('abonnements.update',$abonnement),'files'=>true]) !!}
            ...
            <div class="col-md-6" style="padding: 0px">
                ...
                <div  class="col-sm-12">
                    <div class="checkbox checkbox-primary ">
                        <input name="etat"class="form-control"id="checkbox2" type="checkbox">
                        <label for="checkbox2">
                            Etat
                        </label>
                    </div>
