  ...
  <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Catégorie</h4>
                        ...
                        <div class="m-b-30 pull-right">
                            ...
                            @can('add_categories')
                            <button type="button" class="btn btn-primary waves-effect waves-light btnadd"  data-toggle="modal" data-target="#con-close-modal" data-lien="categories/create"><i class="fa fa-plus"></i>&nbsp;Ajouter une catégorie </button> @endcan
                            ...
                            <table class="table table-bordered  table-striped" id="datatable-buttons">
                                ...
                                <tbody id="tablebody">
                                    ...
                                    <tr class="gradeC">
                                        ...
                                        <td style="width:600px"> {{ $categorie->nom }}</td>
