                                    ...
                                    <div class="portfolioContainer row">
                                        ...
                                        <div class="col-sm-6 col-lg-3 col-md-4  {{$categorieproduit->categorie_id}}  illustrator">
                                            <div class="gal-detail thumb">
                                                ...
                                                <a data-toggle="modal" data-target="#con-close-modal" data-lien="categorieproduits/{{$categorieproduit->id}}/edit" data-id="{{$categorieproduit->id}}" class="btn-success btnedit btn btn-primary"><i class="fa fa-pencil"></i></a>
