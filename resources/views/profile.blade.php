                                                ...
                                                <div class="col-sm-12">
                                                    <div class="bg-picture text-center" style="background-image:url('{{asset('images/big/bg.jpg')}}')">
                                                        ...
                                                        <div class="profile-info-name">
                                                            <img src="{{asset('images/'.auth()->user()->roles->first()->image)}}" class="thumb-lg img-circle img-thumbnail" alt="profile-image">
                                                                ...
                                                                <div class="panel panel-default panel-fill">
                                                                    ...
                                                                    <div class="panel-body"> 
                                                                        ...
                                                                        <div class="about-info-p">
                                                                            <strong>Email</strong>
                                                                            <br>
                                                                            <p class="text-muted">{{auth()->user()->roles->first()->email}}</p>
                                                                        </div>
