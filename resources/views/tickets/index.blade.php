                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                                    ...
                                                                                    <div class="col-sm-12">
                                                                                        <select name="type" class="form-control">
                                                                                          <option value="1">Pourcentage</option>
                                                                                            <option value="annnuel">Montant</option>
                                                                                          </select>
                                                                                     </div>
                                                                                </div>
                                                                       ...
                                                                       {!! Form::close() !!}
                                                                        ...
                                                                        @can('add_tickets')                                         <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal2">Ajouter <i class="fa fa-plus"></i></button>                                     @endcan
