  ...
  <div class="content-page">
                ...
                <div class="content">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
                                            ...
                                            <div class="col-md-6" style="padding: 0px">
                                                <label for="inputPassword3" class="col-sm-12 control-label">{!! Form::label('identifiant','Identifiant') !!}</label>
                                                <div class="col-sm-12">
                                                  <input type="text" name="identifiant" class="form-control">
          </div>
                                            </div>
                                            <div class="col-md-6" style="padding: 0px">
                                                <label for="inputPassword3" class="col-sm-12 control-label">{!! Form::label('motpasse','Mot de passe') !!}</label>
                                                <div class="col-sm-12">
                   ...
                   <tr class="gradeC">
                                            ...
                                            {!! Form::close() !!}
                                                <a href="javascript:;" class="btnedit btn btn-default"><i class="fa fa-pencil"></i></a>
