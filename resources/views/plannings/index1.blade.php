                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="portfolioFilter">
                                            ...
                                            @if ($categorie->id==$id)
                                            <a href="#" data-filter=".{{$categorie->id}}" class="current">{{$categorie->nom}}</a>
                                        
                                            @endif
                                            @if ($categorie->id!=$id)
                                <a href="#" data-filter=".{{$categorie->id}}" class="">{{$categorie->nom}}</a>
                                ...
                                <div class="port">
                                    <div class="portfolioContainer row">
                                         ...
                                         @endif
                                         @if ($produit->categori_id!=$id)
                                         <div class="col-sm-6 col-lg-3 col-md-4  {{$produit->categori_id}}  illustrator"   style="position: absolute; left: 0px; top: 0px; display: none;">
                                            <div class="gal-detail thumb">
                                                <a href="{{asset('images/'.$produit->image)}}" class="image-popup" title="Screenshot-1">
                                                    <img src="{{asset('images/'.$produit->image)}}" class="thumb-img" alt="work-thumbnail">
                                                </a>
