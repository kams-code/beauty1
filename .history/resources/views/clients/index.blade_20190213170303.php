  ...
  <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Cl</h4>
                        ...
                        <div class="m-b-30 pull-right">
                            ...
                            @can('add_clients')
                            <button type="button" class="btn btn-primary waves-effect waves-light btnadd"  data-toggle="modal" data-target="#con-close-modal" data-lien="clients/create"><i class="fa fa-plus"></i>&nbsp;Ajouter un institut </button> @endcan
                            @can('delete_clients')
