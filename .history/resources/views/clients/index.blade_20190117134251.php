                                ...
                                <table class="table table-bordered table-striped" id="datatable-editable">
                                    ...
                                    @foreach($clients as $client)
                                       ...
                                       <tr class="gradeC">
                                            ...
                                            <td class="actions">
                                                <a href="{{ route('clients.edit',$organisation) }}" class="hidden on-editing save-row"><i class="fa fa-save"></i></a>
                                                <a href="{{ route('clients.edit',$organisation) }}" class="hidden on-editing cancel-row"><i class="fa fa-times"></i></a>
                                                <a href="{{ route('clients.edit',$organisation) }}" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
