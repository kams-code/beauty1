<div class="modal-content">
    ...
    <div class="modal-body">
        <div class="row">
            {!! Form::open(['method'=>'PUT','class' => 'form-horizontal','role' => 'form','url' => route('services.update',$equipement),'files'=>true]) !!}
            ...
            <div class="col-md-6" style="padding: 0px">
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control" name="code" value="{{$equipement->code}}" required="">
                </div>
            </div>
            <div class="col-md-6" style="padding: 0px">
            ...
            <div class="col-md-6" style="padding: 0px">
                ...
                <div class="col-sm-12">
                    <input type="number" class="form-control" name="montant" value="{{$equipement->montant}}" required="">
                </div>
            </div>
            <div class="col-md-6" style="padding: 0px">
                <label for="inputPassword3" class="col-sm-12 control-label">{!! Form::label('categorie_id','Categorie*') !!}</label>
                <div class="col-sm-12">
                    <input type="select" class="form-control" name="categorie_id" value="{{$equipement->categorie_id}}" >
                </div>
            </div>
            </br>
            <div class="col-md-6" style="padding: 0px">
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control" name="user_id" value="{{$equipement->user_id}}" >
