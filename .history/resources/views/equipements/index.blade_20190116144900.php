  ...
  <div class="content-page">
                ...
                <div class="content">
                   ...
                   <tr class="gradeC">
                                            ...
                                            <td class="actions">
                                                <a href="{{ route('equipements.edit',$produit) }}" class="hidden on-editing save-row"><i class="fa fa-save"></i></a>
                                                <a href="{{ route('equipements.edit',$produit) }}" class="hidden on-editing cancel-row"><i class="fa fa-times"></i></a>
                                                <a href="{{ route('equipements.edit',$produit) }}" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
