                            ...
                            <table class="table table-bordered  table-striped" id="datatable-buttons">
                                ...
                                <tbody id="tablebody">
                                    ...
                                    <tr class="gradeC">
                                        ...
                                        <td> <a class="on-default seedetails btn btn-primary" data-toggle="modal" data-lien="fournisseurs/{{$equipement->id}}" data-id="{{$equipement->id}}" data-target="#con-close-modal">{{$equipement->Fournisseur->nom}}</a></td>
