                            ...
                            <div class="m-b-30 pull-right">
                                ...
                                <div class="col-sm-6 col-lg-3 col-md-4 webdesign illustrator">
                                    <div class="gal-detail thumb">
                                        ...
                                        <a data-toggle="modal" data-target="#con-close-modal" data-lien="categories/{{$categorie->id}}/edit" data-id="{{$categorie->id}}" class="btn-delete btnedit btn btn-primary pull-right">{{$categorie->montant}}</i>.$categorie->image)}}" class="thumb-img" alt="work-thumbnail">
                                        </a>
                                        <div  >
