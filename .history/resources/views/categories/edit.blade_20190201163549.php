    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-12" style="padding: 0px">
                <center>
                    <img id="imgpreview" src="{{asset('images/'.$categorie->image)}}" style="width: 130px; height:120px; cursor: pointer;" required>
            ...
            <div class="col-md-6" style="padding: 0px">
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control" name="code" value="{{$categorie->code}}" required="">
                </div>
            </div>
            <div class="col-md-6" style="padding: 0px">
            ...
            <div class="col-md-6" style="padding: 0px">
                ...
                <div class="col-sm-12">
                    <input type="number" class="form-control" name="montant" value="{{$categorie->montant}}" required="">
                </div>
            </div>
            <div class="col-md-6" style="padding: 0px">
                <label for="inputPassword3" class="col-sm-12 control-label">{!! Form::label('categorie_id','Categorie*') !!}</label>
                <div class="col-sm-12">
                    <input type="select" class="form-control" name="categorie_id" value="{{$categorie->categorie_id}}" >
                </div>
            </div>
            </br>
            <div class="col-md-6" style="padding: 0px">
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control" name="user_id" value="{{$categorie->user_id}}" >
            ...
            <div class="col-md-12" style="padding: 0px">
                ...
                <div class="col-sm-12">
                    <textarea class="form-control" name="description" required>{{$categorie->description}}</textarea>
                </div>
            </div>
