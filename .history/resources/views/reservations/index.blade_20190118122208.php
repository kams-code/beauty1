                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
                                            ...
                                            <div class="form-group">
                                                <label for="inputPassword3" class="col-sm-3 control-label">{!! Form::label('client_id','Fournisseur') !!}</label>
                                                <div class="col-sm-9">
                                                    {!! Form::select('client_id',$fournisseurs,null, ['class' => 'form-control']) !!}
