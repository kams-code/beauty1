                ...
                <div class="content">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
                                            ...
                                            <div class="form-group">
                                                <label for="inputPassword3" class="col-sm-3 control-label">{!! Form::label('description','PASSWORD_BCRYPT') !!}</label>
                                                <div class="col-sm-9">
                   ...
                   <tr class="gradeC">
                                            ...
                                            <td class="actions">
                                                ...
                                                <a href="{{ route('organisations.edit',$organisation) }}" class="hidden on-editing cancel-row"><i class="fa fa-times"></i></a>
