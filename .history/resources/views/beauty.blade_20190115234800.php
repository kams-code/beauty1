...
<head>
        ...
        <link href="resources/assets/plugins/sweetalert/dist/sweetalert.css" rel="stylesheet" type="text/css">
        ...
        <link href="esources/assets/css/responsive.css" rel="stylesheet" type="text/css">
    ...
    <body class="fixed-left">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index-2.html" class="logo"><i class="md md-terrain"></i> <span>Moltran </span></a>
                    </div>
                </div>
        ...
        <!-- jQuery  -->
        <script src="resources/assets/plugins/waypoints/lib/jquery.waypoints.js"></script>
        <script src="resources/assets/plugins/counterup/jquery.counterup.min.js"></script>
        
        <!-- jQuery  -->
        <script src="resources/assets/plugins/sweetalert/dist/sweetalert.min.js"></script>
        
        
        <!-- flot Chart -->
        <script src="resources/assets/plugins/flot-chart/jquery.flot.js"></script>
        <script src="resources/assets/plugins/flot-chart/jquery.flot.time.js"></script>
        <script src="resources/assets/plugins/flot-chart/jquery.flot.tooltip.min.js"></script>
        <script src="resources/assets/plugins/flot-chart/jquery.flot.resize.js"></script>
        <script src="resources/assets/plugins/flot-chart/jquery.flot.pie.js"></script>
        <script src="resources/assets/plugins/flot-chart/jquery.flot.selection.js"></script>
        <script src="Resources/assets/plugins/flot-chart/jquery.flot.stack.js"></script>
        <script src="Resources/assets/plugins/flot-chart/jquery.flot.crosshair.js"></script>

        <!-- jQuery  -->
        <script src="Resources/assets/pages/jquery.todo.js"></script>
        
        <!-- jQuery  -->
        <script src="Resources/assets/pages/jquery.chat.js"></script>
