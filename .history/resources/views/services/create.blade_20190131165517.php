    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-6" style="padding: 0px">
                ...
                <div class="col-sm-12">
                {!! Form::select('users[]', $users, null, ['class' => 'form-control','required','multiple'=>'multiple']) !!}
                </div>
            </div>
            <div class="col-md-6" style="padding: 0px">
                <label for="inputPassword3" class="col-sm-12 control-label">{!! Form::label('categorie_id','employe') !!}</label>
                <div class="col-sm-12">
                {!! Form::select('categorie_id',$clients,null, ['class' => 'form-control','required']) !!}
                </div>
            </div>
            ...
            <div class="checkbox" style="padding: 0px">
                <label for="checkbox" class="col-sm-12 control-label"  >
                            En promotion?
                        </label> 
                <input class="form-control"  id="checkbox" type="checkbox" name="is_promote" > 
