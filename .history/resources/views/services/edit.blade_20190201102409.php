    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-6" style="padding: 0px">
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control" name="adresse" value="{{$service->adresse}}" required="">
                </div>
            </div>
            <div class="col-md-6" style="padding: 0px">
                <label for="inputPassword3" class="col-sm-12 control-label">{!! Form::label('user_id','Pays*') !!}</label>
                <div class="col-sm-12">
