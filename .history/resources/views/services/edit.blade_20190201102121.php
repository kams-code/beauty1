    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-6" style="padding: 0px">
                ...
                <div class="col-sm-12">
                    <input type="number" class="form-control" name="code" value="{{$service->code}}" required="">
                </div>
            </div>
            <div class="col-md-6" style="padding: 0px">
            ...
            <div class="col-md-6" style="padding: 0px">
                ...
                <div class="col-sm-12">
                    <input type="number" class="form-control" name="email" value="{{$organisation->email}}" required="">
                </div>
            </div>
            <div class="col-md-6" style="padding: 0px">
