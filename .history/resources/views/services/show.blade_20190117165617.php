  ...
  <div class="content-page">
                ...
                <div class="content">
                   ...
                   <tr class="gradeC">
                                            ...
                                            @endif
                                            <td class="actions">
                                                <a href="{{ route('services.edit',$reservation) }}" class="hidden on-editing save-row"><i class="fa fa-save"></i></a>
                                                <a href="{{ route('services.edit',$reservation) }}" class="hidden on-editing cancel-row"><i class="fa fa-times"></i></a>
                                                <a href="{{ route('services.edit',$reservation) }}" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
