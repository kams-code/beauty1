    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-6" style="padding: 0px">
                <label for="inputPassword3" class="col-sm-12 control-label">{!! Form::label('code','Téléphone*') !!}</label>
                <div class="col-sm-12">
                    <input type="number" class="form-control" name="telephone" value="{{$service->code}}" required="">
                </div>
            </div>
            <div class="col-md-6" style="padding: 0px">
