...
<div class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title">editer un service</h4>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12" style="padding: 0px">
                <center>
                    ...
                    <input id="inputimage" type="file" name="imageup" accept="images/*"  value="{{$service->image}}" style="display: none;" required>
            ...
            <div class="col-md-12" style="padding: 0px">
                ...
                <div class="col-sm-12">
                    {!! Form::number('montant',$service->montant, ['class' => 'form-control','required']) !!}
                </div>
            </div>
            <div class="col-md-6" style="padding: 0px">
            ...
            <div class="col-md-6" style="padding: 0px">
                ...
                <div class="col-sm-12">
                {!! Form::select('categorie_id',$categories,$service->categorie_id, ['class' => 'form-control']) !!}
                </div>
            </div>
            ...
            <div class="col-md-12" style="padding: 0px">
                ...
                <div class="col-sm-12">
                    <textarea class="form-control" name="description" value="{{$service->description}}" required></textarea>
                </div>
            </div>
