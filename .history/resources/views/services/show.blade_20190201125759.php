            ...
            {!! Form::open(['class' => 'form-horizontal','role' => 'form','url' => route('services.store'),'files'=>true]) !!}
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6" style="padding: 4px">
                        <strong>Montant:</strong>{{$organisation["montant"]}}
                    </div>
                ...
                <div class="col-md-12">
                    <h4><b >Informations sur la categorie du service</b></h4>
                </div>
                <div class="col-md-6" style="padding: 0px">
                    <label for="inputPassword3" class="col-sm-12 control-label">{!! Form::label('categorie_id','Identifiant') !!}</label>
                    <div class="col-sm-12">
                        {{$sevice["categorie_id"]}}
                    </div>
                </div>
