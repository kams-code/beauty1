                                              ...
                                              <div class="col-md-12">
                                                  <div class="panel panel-default">
                                                      ...
                                                      <div class="panel-body">
                                                          <div class="clearfix">
                                                              <div class="pull-left">
                                                                  <h4 class="text-right"><img height="50" width="50" src="{{asset('images/'.$role->image)}}" alt="velonic"></h4>
                                                          ...
                                                          <div class="row">
                                                              <div class="col-md-12">
                                                                  ...
                                                                  <div class="pull-left m-t-30">
                                                                      <address>
                                                                        <strong>{{$role->nom}}, Inc.</strong><br>
                                                                        {{$role->pays}},  <br>
                                                                        {{$role->ville}}, {{$role->adresse}}94107<br>
                                                                        <abbr title="Phone">P:</abbr> {{$role->telephone}}
                                                                        </address>
                                                                  </div>
